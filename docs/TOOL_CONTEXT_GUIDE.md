...
- 外部参考ツール
- Code・Codex の補助検討
- Codex PMO からの客観レビュー、反対意見、リスク確認
- Gemini と同じく外部レビュー役として扱い、最終判断は行わない
